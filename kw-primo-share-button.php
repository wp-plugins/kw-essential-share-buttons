...
function kw_share_buttons($content)
{
	if(is_single())
	{
		...
		echo '<div class="kw-share-this">
			...
			<a class="msn-share-button" href="#" onclick="javascript:window.open(\'http://profile.live.com/badge?url=' . get_permalink($post->post_parent) .'/\', \'Windows Live\', \'width=550, height=450, top=230, right=450, left=450\'); return false;" title="Messenger live share">Messenger</a>
